...
d3.select('.my-supah-svg').append('svg:image')
  .attr('class', 'final-bg')
  .attr('pointer-events', 'none')
  .attr('xlink:href', 'https://dl.dropboxusercontent.com/u/56517582/exterior_bw.png')
  .attr('width', imageWidth)
  .attr('height', imageHeight)
...
svg.append("svg:image")
  .attr('pointer-events', 'none')
  .attr('xlink:href', 'https://dl.dropboxusercontent.com/u/56517582/hanahaus/img/logo.png')
